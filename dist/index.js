...
var nextActions = ['again', 'change', 'exit'];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, promptSelect("\u30B2\u30FC\u30E0\u306E\u30BF\u30A4\u30C8\u30EB\u3092\u5165\u308C\u3066\u304F\u3060\u3055\u3044", gameTitles)];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        action = _a.sent();
                        if (!(action == 'again')) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.play()];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 9];
                    case 5:
                        if (!(action == 'change')) return [3 /*break*/, 8];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, promptSelect('モードを入れてください', modes)];
                    case 1:
                        _a.mode = _b.sent();
